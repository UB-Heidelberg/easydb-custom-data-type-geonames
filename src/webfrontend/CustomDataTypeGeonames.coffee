class CustomDataTypeGeonames extends CustomDataTypeWithCommons
  ...
  __getAdditionalTooltipInfo: (uri, tooltip,extendedInfo_xhr) ->
    ...
    .fail (data, status, statusText) ->
        console.log 'FAIL', extendedInfo_xhr.xhr.getXHR(), extendedInfo_xhr.xhr.getResponseHeaders()
  ...
  __updateSuggestionsMenu: (cdata, cdata_form, suggest_Menu, searchsuggest_xhr) ->
    ...
    setTimeout ( ->
        ...
        searchsuggest_xhr.xhr.start().done((data, status, statusText) ->
            ...
            console.log 'OK', searchsuggest_xhr.xhr.getXHR(), searchsuggest_xhr.xhr.getResponseHeaders()
    ...
    new CUI.ButtonHref
      ...
      tooltip:
        ...
        content: (tooltip) ->
          ...
          tooltip.DOM.innerHTML = htmlContent
          tooltip._pane.DOM.innerHTML = htmlContent
          tooltip.autoSize()
          htmlContent
